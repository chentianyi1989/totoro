        ...
        <div class="row">
            {{--<div class="col-lg-2">--}}
                {{--<div class="input-group">--}}
                    ...
                    {{--<select name="api_type" id="api_type" class="form-control">--}}
                        ...
                        {{--@foreach(config('platform.api_type') as $k => $v)--}}
            ...
            <div class="col-lg-4">
                <div class="input-group">
                    ...
                    <select name="gameType[]" id="gameType[]" class="form-control select2" multiple="multiple">
                        <option value="">--请选择--</option>
                        @foreach(config('platform.game_type') as $k => $v)
                            <option value="{{ $k }}" @if(in_array($k, $gameType)) selected @endif>{{ $v }}</option>
                        @endforeach
                    </select>
