    ...
    <div class="container">
        <ul class="clear">
            ...
            <li>
                ...
                <div class="foot-game">
                    <em>真人娱乐城</em>
                    <p>{{ $_system_config->site_name }}提供多个最受欢迎的真人娱乐场游戏，包括真人娱乐百家乐﹑二十一点﹑骰宝﹑龙虎及轮盘等等游戏。 我们还为您提供VIP至尊包桌服务，
                        可咪牌，自由飞牌，任换荷官，任换牌靴等。</p>
                </div>
                <div class="foot-game">
                    <em>老虎机及电子游戏</em>
                    <p>游戏包括轮盘、21点、电子扑克、老虎机等在线娱乐场游戏，丰厚的累积奖池与超高积分让您体验更刺激的游戏乐趣。</p>
                </div>
            </li>
            <li>
                <div class="title">
...
<div class="footer-ft clear">
    <div class="container">
        <div class="pullRight">
            <ul>
                <li><a href="javascript:;">关于{{ $_system_config->site_name }}</a></li>
